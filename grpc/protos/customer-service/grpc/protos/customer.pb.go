...
func (x *LoginResponse) GetCustomer() *CustomerInfo {
	if x != nil {
		return x.Customer
	}
	return nil
...
func (x *CustomerInfo) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CustomerInfo) GetPermissions() []string {
	if x != nil {
...
func (x *CustomerInfo) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *CustomerInfo) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
const file_customer_proto_rawDesc = "" +
	...
	"\bcustomer\x18\x02 \x01(\v2\x16.customer.CustomerInfoR\bcustomer\"\xb0\x01\n" +
	...
	"\x05valid\x18\x01 \x01(\bR\x05valid2\x97\x01\n" +
	"\x0fCustomerService\x128\n" +
	"\x05Login\x12\x16.customer.LoginRequest\x1a\x17.customer.LoginResponse\x12J\n" +
	"\vVerifyToken\x12\x1c.customer.VerifyTokenRequest\x1a\x1d.customer.VerifyTokenResponseB\x1eZ\x1ccustomer-service/grpc/protosb\x06proto3"
...
var file_customer_proto_goTypes = []any{
	(*LoginRequest)(nil),        // 0: customer.LoginRequest
	(*LoginResponse)(nil),       // 1: customer.LoginResponse
	(*CustomerInfo)(nil),        // 2: customer.CustomerInfo
	(*VerifyTokenRequest)(nil),  // 3: customer.VerifyTokenRequest
	(*VerifyTokenResponse)(nil), // 4: customer.VerifyTokenResponse
}
var file_customer_proto_depIdxs = []int32{
	2, // 0: customer.LoginResponse.customer:type_name -> customer.CustomerInfo
	0, // 1: customer.CustomerService.Login:input_type -> customer.LoginRequest
	3, // 2: customer.CustomerService.VerifyToken:input_type -> customer.VerifyTokenRequest
	1, // 3: customer.CustomerService.Login:output_type -> customer.LoginResponse
	4, // 4: customer.CustomerService.VerifyToken:output_type -> customer.VerifyTokenResponse
